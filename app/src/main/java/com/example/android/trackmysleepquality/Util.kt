...
// COMPLETED (11) Uncomment the code.

fun formatNights(nights: List<SleepNight>, resources: Resources): Spanned {
    val sb = StringBuilder()
    sb.apply {
        append(resources.getString(R.string.title)) // The header
        nights.forEach {
            append("<br>")
            ...
            // Append the end time and the statistics only if this is a completed sleep recording:
            // i.e. start- and end times differ.
